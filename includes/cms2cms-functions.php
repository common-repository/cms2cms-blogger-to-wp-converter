...
/**
 * Class CmsPluginFunctionsBlogger
 */
class CmsPluginFunctionsBlogger
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback" : "//wordpress.org/support/plugin/cms2cms-blogger-to-wp-converter/reviews",
    ...
    {
        $cms2cms_blogger_access_login = get_option('cms2cms-blogger-login');
        $cms2cms_blogger_access_key   = get_option('cms2cms-blogger-key');

        return array(
            'email'     => $cms2cms_blogger_access_login,
            'accessKey' => $cms2cms_blogger_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_blogger_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-blogger-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-blogger-key', $key);

            delete_option('cms2cms-blogger-login');
            add_option('cms2cms-blogger-login', $login);

            delete_option('cms2cms-blogger-depth');
            add_option('cms2cms-blogger-depth', $bridge_depth);
    ...
    {
        return $this->__('Blogger', 'cms2cms-blogger-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-blogger-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-blogger-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-blogger-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_blogger_logout')
                && $_POST['cms2cms_blogger_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
